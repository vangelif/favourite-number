...
# 📖 [Favourite Number] <a name="about-project"></a>

**Favourite Number** is a project that we are applying our knowledge on HTML and CSS and JavaScript to fetch movies from TVMAZE API, and allow users to post comments, likes, read summaries of movies that they choose to and update our base API with their comments and likes.
...
- **[cd your-folder]**
- **[git clone https://github.com/vangelif/favourite-number.git]**
